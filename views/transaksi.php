...
// PASTIKAN FILE INI DIMULAI TEPAT DENGAN <?php

// Tidak ada kode require_once atau instansiasi Model di sini!
...
// Kriteria OOP: View hanya menampilkan data. Variabel-variabel ini berasal dari Controller (via extract()).
                                    ...
                                    <h6 class="mb-3 text-primary">Informasi Pemilik</h6>
                                        <div class="mb-3">
                                            ...
                                            <select name="id_pelanggan" class="form-select" id="selectPelanggan" required>
                                                ...
                                                <?php foreach ($pelangganList as $p): // $pelangganList sudah disiapkan Controller ?>
                                        ...
                                        <script>
                                            // Menyediakan data PHP ke variabel JavaScript global
                                            const PHP_DATA = {
                                                kandangTersedia: <?= json_encode($kandangTersedia ?? []) ?>,
                                                hewanMenginap: <?= json_encode($hewanMenginap ?? []) ?>
                                                // TIDAK PERLU DATA PELANGGAN DI SINI KARENA SUDAH DI-RENDER DI DROPDOWN
                                            };
                                        </script>
                                ...
                                <div class="card p-3">
                                    ...
                                    <div class="row g-3">
                                            ...
                                            <select name="id_layanan" class="form-select" id="paketSelect" required>
                                                ...
                                                <?php foreach ($paketList as $pk): // Menggunakan $paketList dari Controller ?>
...
<script>
    ...
    const PHP_DATA = {
        kandangTersedia: <?= json_encode($kandangTersedia ?? []) ?>,
        hewanMenginap: <?= json_encode($hewanMenginap ?? []) ?>
        // Tambahkan data lain jika diperlukan (misal: data layanan)
    };
</script>
